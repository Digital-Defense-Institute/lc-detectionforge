      ...
      <div class="section">
        ...
        <div class="section rule-logic-section">
          ...
          <div class="actions">
            ...
            <!-- Export Options -->
            <div class="action-group export-options">
              <label class="checkbox-wrapper">
                <input v-model="includeIaCBoilerplate" type="checkbox" />
                <span class="checkbox-label">Include boilerplate text in IaC export</span>
              </label>
            </div>
...
// Include IaC boilerplate checkbox state (persistent)
...
function exportToIaC() {
  ...
  try {
    ...
    const headerComments = includeIaCBoilerplate.value
